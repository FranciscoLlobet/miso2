...
// Local constants
pub const osFlagsWaitAny = c.osFlagsWaitAny;
pub const osFlagsWaitAll = c.osFlagsWaitAll;
pub const osFlagsNoClear = c.osFlagsNoClear;

// Types
pub const osEventFlagsAttr_t = c.osEventFlagsAttr_t;
pub const osEventFlagsId_t = c.osEventFlagsId_t;
pub const osRtxEventFlags_t = c.osRtxEventFlags_t;
...
pub fn new(attr: ?*const osEventFlagsAttr_t) @This() {
    return @This().create(c.osEventFlagsNew(attr));
}

/// Get event flags name
pub fn getName(self: *const @This()) ?[*:0]const u8 {
    return c.osEventFlagsGetName(self.id);
}

/// Set specified event flags
pub fn set(self: *const @This(), flags: u32) osError!u32 {
    return osFlagsErrorMap(c.osEventFlagsSet(self.id, flags));
}

/// Clear specified event flags
pub fn clear(self: *const @This(), flags: u32) osError!u32 {
    return osFlagsErrorMap(c.osEventFlagsClear(self.id, flags));
}

/// Get current event flags
pub fn get(self: *const @This()) osError!u32 {
    return osFlagsErrorMap(c.osEventFlagsGet(self.id));
}

/// Wait for one or more event flags to become signaled
pub fn wait(self: *const @This(), flags: u32, options: u32, timeout: u32) osError!u32 {
    return osFlagsErrorMap(c.osEventFlagsWait(self.id, flags, options, timeout));
}

/// Delete the event flags object
pub fn delete(self: *const @This()) osError!void {
    return osErrorMap(c.osEventFlagsDelete(self.id));
}
...
pub fn StaticEventFlags(comptime name: [*:0]const u8) type {
    return struct {
        ...
        pub fn new(self: *@This(), attr_bits: u32) osError!void {
            ...
            const attr: c.osEventFlagsAttr_t = .{
                .name = name,
                .attr_bits = attr_bits,
                .cb_mem = &self.cb,
