 ...
 *
 * lwIP configuration for FRDM-MCXE247 (Cortex-M4, 256 kB SRAM).
 * Injected into the lwip package via addIncludePath, analogous to how
 * rtx_config/ is injected into the cmsis_rtx package.
 */
...
/* =========================================================================
 * Operating mode: RTOS (RTX5 / CMSIS-RTOS2), NO_SYS=0
 * ========================================================================= */
#define NO_SYS 0
